...
//////////////// CONSTANTS: //////////////////////////////////
`define nbins 40 // number of time bins in the shift register
...
// Assign slow pulse signals to outputs: 
...
// Assign pulse signals to outputs (OR LOGIC: the output is high if the slow or the fast sequencer sets it high):
...
// Photons will only be detected if phcountbool is high (AND LOGIC: both slow and fast sequencer must enable photon counting)
